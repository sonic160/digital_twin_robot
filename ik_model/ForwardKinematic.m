...
j1 = resample(out.j1,0.01:0.01:10,'zoh').data*180/pi;
j2 = resample(out.j2,0.01:0.01:10,'zoh').data*180/pi;
j3 = resample(out.j3,0.01:0.01:10,'zoh').data*180/pi;
j4 = resample(out.j4,0.01:0.01:10,'zoh').data*180/pi;
j5 = resample(out.j5,0.01:0.01:10,'zoh').data*180/pi;
